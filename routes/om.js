...
router.post('/', function (req, res) {
        ...
        //pull out subscription object
        var subscription = obj['soapenv:envelope']['soapenv:body'].notifications.notification.sobject;
        
        //get the subscription's name
        var name = subscription['sf:name'];
        console.log(name);
        ...
        req.io.sockets.emit("outboundmessage", { subscriptionname: subscription['sf:name'], mailingaddr: subscription['sf:mailing_address__c'] });
